...
class create_cisco_event extends StatefulWidget {
  final user;
  create_cisco_event(this.user);
  @override
  _create_cisco_eventState createState() => _create_cisco_eventState();
}

class _create_cisco_eventState extends State<create_cisco_event> {
  String url = '';
                        ...
                        children: [
                          ...
                          RaisedButton(
                              ...
                              onPressed: () async{
                                ...
                                var r=await conn.query(sql,[widget.user,topic,currentSelectedValue,start_time.toString(),end_time.toString(),duration.toString(),link,'cisco']);
                                conn.close();
