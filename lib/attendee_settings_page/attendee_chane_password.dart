...
class attendee_change_password extends StatefulWidget {
  final user;
  attendee_change_password(this.user);
  @override
  _attendee_change_passwordState createState() => _attendee_change_passwordState();
}

class _attendee_change_passwordState extends State<attendee_change_password> {
