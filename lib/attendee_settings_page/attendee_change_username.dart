...
class attendee_change_username extends StatefulWidget {
  final user;
  attendee_change_username(this.user);
  @override
  _attendee_change_usernameState createState() => _attendee_change_usernameState();
}

class _attendee_change_usernameState extends State<attendee_change_username> {
                  ...
                  child: RaisedButton(
                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          ...
                          var r=await conn.query('update attendee set attendee_name=? where attendee_id=?',[username,widget.user] );
                          conn.close();
