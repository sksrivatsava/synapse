...
class eventu{
  ...
  eventu(this.event_id,this.event_name,this.domain_name,this.channel_name,this.start_time,this.end_time,this.event_platform);
}
  ...
  void getdata() async{
    ...
    for(var i in r){
      setState(() {
        ...
        l.add(eventu(i[0], i[1], i[2], i[3],st,et,  i[6]));
